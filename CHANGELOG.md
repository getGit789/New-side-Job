...
Read the entry for the version you are installing before you update (`docs/operations.md`).

## 1.0.0 (unreleased)

First release. Owner, staff and client roles; clients and contacts with single-use invitations; projects with
staff assignment, fixed intake brief, milestones with client visibility; deliverables with immutable file or link
